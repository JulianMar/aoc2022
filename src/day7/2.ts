...
const sortedDirs = result.sort((a, b) => a - b);

const freeSpace = 70000000 - sortedDirs.pop();
console.log(freeSpace);
const needed = 30000000 - freeSpace;
const res = sortedDirs.findIndex((dir) => dir > needed);

console.log(sortedDirs, needed, res);
printResult(sortedDirs[res]);
